...
6. Use Lagged MdRQA to find the lags in the messed Lorenz system. Re-do the analysis from Exercise 5, but use the lagged MdRQA wrapper. Here we resample the Lorenz system for a quicker computation.
